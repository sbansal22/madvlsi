...
C {madvlsi/isource.sym} 6610 -90 0 0 {name=Ib
value=1u}
C {devices/lab_pin.sym} 6610 -120 1 0 {name=l15 sig_type=std_logic lab=Vbp}
C {madvlsi/gnd.sym} 6610 -60 0 0 {name=l16 lab=GND}
C {madvlsi/tt_models.sym} 6690 -130 0 0 {
name=TT_MODELS
only_toplevel=false
value=".option wnflag=1
.lib ~/skywater/skywater-pdk/libraries/sky130_fd_pr_ngspice/latest/models/sky130.lib.spice tt"
}
C {devices/code_shown.sym} 6630 -280 0 0 {name=SPICE only_toplevel=false value=".ac dec 20 1 1e9
.save all"}
